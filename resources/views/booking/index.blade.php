...
@section('title', 'LuxeStay Hotel - Book Your Perfect Stay')
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-delay="200">
                    <div class="card glass-card shadow-lg border-0" style="border-radius: 20px; backdrop-filter: blur(20px); background: rgba(255, 255, 255, 0.95);">
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('booking.check-availability') }}" method="POST" id="availabilityForm">
                                @csrf
                    ...
                    <div class="card room-category-card h-100">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div>
                                    <h4 class="card-title fw-bold mb-1">{{ $room['name'] }}</h4>
                            ...
                            <div class="price-section mb-4">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <div class="text-end">
                                        <span class="h4 mb-0 text-primary fw-bold">৳{{ number_format($room['price']) }}</span>
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    @foreach(explode(',', $room['amenities']) as $amenity)
                                        <span class="badge bg-light text-dark border">
                                            <i class="bi bi-check2 me-1 text-success"></i>{{ trim($amenity) }}
                                        </span>
                                    @endforeach
                                </div>
                            </div>
                        ...
                        <div class="card-footer bg-transparent border-0 p-4 pt-0">
                            <button class="btn btn-outline-primary w-100" onclick="selectRoom('{{ $room['name'] }}')">Select This Room</button>
                        </div>
                    </div>
                </div>
            @endforeach
