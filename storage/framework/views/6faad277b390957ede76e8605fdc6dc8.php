...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            <a class="navbar-brand text-gradient" href="<?php echo e(route('booking.index')); ?>">
    ...
    <footer class="bg-dark text-white mt-5">
        <div class="container py-5">
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <p class="mb-0">&copy; <?php echo e(date('Y')); ?> LuxeStay Hotel. All rights reserved.</p>
                </div>
...
</html><?php /**PATH /Users/raihanulislma/Desktop/hotel-booking-task-Raihanul-Islam/resources/views/layout.blade.php ENDPATH**/ ?>